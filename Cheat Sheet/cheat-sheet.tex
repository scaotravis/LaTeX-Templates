...
\newmdtheoremenv[style=tightTop]{theorem}{\color{Maroon}{\textbf{Theorem}}}[section]
...
%\theoremstyle{definition}
\newmdtheoremenv[style=tightTop]{definition}{\color{MidnightBlue}{\textbf{Definition}}}[section]
